...
const gen = generator => {
    ...
    const $ro0 = (_recursive = false, _depth = 0) => { var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k; return ({
        ...
        ])) !== null && _j !== void 0 ? _j : ((_k = generator === null || generator === void 0 ? void 0 : generator.pattern) !== null && _k !== void 0 ? _k : $generator.pattern)(/^[A-Zㄱ-ㅎㅏ-ㅣ가-힣]*$/)
    }); };
    return $ro0();
};
const hundred = [];
...
const arrayInsert = (array) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { data, error } = yield supabaseClient_1.supabase.from('search').insert(array);
